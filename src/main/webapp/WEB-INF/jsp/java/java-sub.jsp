...
<ul>
	...
	<li class="sub-heading">Javabank example</li>
	...
	<li><a href="/java/Javabank-Apply-inheritance">Inheritance</a></li>
	<li><a href="/java/Javabank-Apply-abstract-class">Abstract Class</a></li>
	<li><a href="/java/Javabank-Apply-interface">Interface</a></li>
	<li class="sub-heading">Java Advanced</li>
	<li><a href="/java/Thread">Thread</a></li>
	<li><a href="/java/Stream">Stream</a></li>
