...
<h1 style="float: left; width: 150px;">
	<a href="/"><img src="/resources/images/ci.gif" alt="java-school" /></a>
</h1>
...
<%
	...
	if (query != null) {
		if (query.indexOf("lang=") != -1) {
			if (query.indexOf("&lang=") != -1) {
				query = query.substring(0, query.indexOf("&lang="));
			}
			if (query.indexOf("lang=") != -1) {
				query = query.substring(0, query.indexOf("lang="));
			}
			if (!query.equals("")) {
				String decodedQueryString = java.net.URLDecoder.decode(query, "UTF-8");
